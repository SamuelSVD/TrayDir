...
namespace TrayDir
{
    partial class InstanceManagerForm {
        ...
        private void InitializeComponent()
        {
			...
			this.groupBox1.Text = "Archived Instances";
			// 
			// tableLayoutPanel1
			// 
			...
			// deleteButton
			// 
			this.deleteButton.Location = new System.Drawing.Point(277, 141);
			...
			// restoreButton
			// 
			this.restoreButton.Location = new System.Drawing.Point(3, 141);
